...
import type { UserCredentials } from '@/services/auth.service';
...
export default function LoginPage() {
  ...
  const handleSubmit = async (event: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      let generalErrorMessage = '登录失败，发生未知错误。';
      let specificValidationErrors: ValidationError[] = [];

      if (error instanceof ApiError) {
        generalErrorMessage = error.response?.message || error.message || '登录失败，请检查输入。';
